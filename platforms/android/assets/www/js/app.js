...
.config(function($stateProvider, $urlRouterProvider, $translateProvider, $ionicConfigProvider, $logProvider, $compileProvider) {
  ...
  $translateProvider.translations('en-US', {
    ...
    _french: 'French',
    _german: 'German',
    _vocal_announce: 'Vocal Announcements',
    ...
    _toggle_music_on_announce: 'Toggle music on announcement',
    ...
    _announce_heartrate: 'Announce heart rate',
    ...
    deDE: 'German',
    jaJP: 'Japanese',
    _privacy_policy_text: 'ForRunners doesn\'t send any information outside your device, except to retrieve maps from OpenStreetMap or when you activate the debug mode. When you activate the debug mode, any errors and debug messages will be sent to my own server for debugging.',
    _short_description: 'A GPS tracking application dedicated to runners.',
    _use_open_source_text : 'ForRunners uses parts or library of the following open source projects',
    _by : 'By',
    ...
    _welcome_text: 'It looks like this is your first time using ForRunners. You can start by recording your run with the plus button below or by importing previous running sessions from GPX files in the settings.',
    _announce_fraction: 'Interval announcements',
    _empty_records_text: 'You haven\'t recorded any running sessions yet, so any run would be a new record!',
    _open_source_content: 'Open Source Content',
    _bpm: 'Heart rate',
    _bpms_label: 'bpm',
    _vocal_bpms_label: 'beats per minute',
    _donation: 'If you want to see this app evolve or just want to thank me, you can make a donation in bitcoin:',
    ...
    _help: 'Help',
    _report_issue: 'Report issues on GitHub',
    ...
    _speed_vs_heartrate: 'Speed VS Heart Rate',
    _altitude_vs_heartrate: 'Altitude VS Heart Rate',
    _help_subtitle_1: 'Welcome to ForRunners! This little tutorial will explain to you the main functions of ForRunners. Use the next and previous buttons below to navigate this tutorial.',
    _help_desc_1: 'The main screen displays all your previous running sessions. <br><br><b>1-</b> This button starts a new running session<br><br><b>2-</b> Average statistics calculated from all your sessions<br><br><b>3-</b> Your best running records<br><br><b>4-</b> Rounded length of the session<br><br><b>5-</b> A score representing the difficulty of your run<br><br><b>6-</b> A graph showing the changes in your score and duration',
    _help_subtitle_2: 'This is the screen you will see when running. It shows your run on a map, with detailed statistics and graphics.',
    _help_desc_2: '<b>1-</b> The OpenStreetMap map, showing your run<br><br><b>2-</b> The blue markers are the kilometer markers, while the green "S" marker shows the start location and the red "E" marker for the end location<br><br><b>3-</b> This icon allows you to share your run<br><br><b>4-</b> This icon allows you to delete your session<br><br><b>5-</b> Date of your running session with resume values',
    _help_desc_3: '<b>1-</b> Date<br><br><b>2-</b> Average speed<br><br><b>3-</b> Average pace<br><br><b>4-</b> Distance<br><br><b>5-</b> Duration (hh:mm)<br><br><b>6-</b> Total elevation in meters<br><br><b>7-</b> Total depression in meters<br><br><b>8-</b> Weather on the day of the run<br><br><b>9-</b> Score, duration, distance and pace<br><br>',
    _help_subtitle_3: ' ',
    _help_subtitle_4: ' ',
    _help_desc_4: 'The x-axis (3) shows the distance run in kilometers and the y-axis (2) shows the speed, while the colors of the graph (1) indicate the heart rate zones reached (Requires a bluetooth 4.0 heart rate monitor and a compatible smartphone)',
    _help_subtitle_5: ' ',
    _help_desc_5: 'The x-axis (2) shows the distance run in kilometers and the y-axis (3) shows altitude, while the colors of the graph (1) indicate the heart rate zonez reached (Requires a bluetooth 4.0 heart rate monitor and a compatible smartphone)',
    _help_subtitle_6: ' ',
    _help_desc_6: '<b>1-</b> Average heart rate during your session<br><br><b>2-</b> Table with pace, speed and heart rate by each kilometer run<br><br><b>3-</b> Graph showing the duration in each heart rate zone<br><br>Now click next and start your first running session or import past sessions from the settings.',
    _previous:'Previous',
    _next:'Next',
    _gps_lost:'GPS signal lost',
    _gps_got:'Recovered GPS signal',
    _announce_gpslost: 'Announce when GPS signal is lost',
    ...
    _duration_interval_detail: 'Make announcements at regular intervals',
    _distance_interval_detail: 'Make announcements at kilometer intervals',
    _heartrate_min_detail: 'Your resting heart rate, measured just after waking up',
    _heartrate_max_detail: 'Your maximum heart rate in a 4 minutes sprint just after a 20-minute warm-up.'
  });
...
$translateProvider.translations('de-DE', {
  ...
  $translateProvider.translations('ja-JP', {
    ...
    _french: 'フランス語',
    _japanese: '日本語',
    _vocal_announce: '音声アナウンス',
    _duration_interval: '持続インターバル',
    _minutes: '分',
    _hours: '時間',
    _options: 'オプション',
    _backup_and_restore: 'バックアップと復元',
    _restore: '復元',
    _backup: 'バックアップ',
    _distance_interval: '距離インターバル',
    _notification_slug: 'ForRunners : セッションの記録中 ...',
    _notification_message: 'セッションの記録中 ...',
    _go: 'ゴー !',
    _kilometers: 'キロメートル',
    _kilometers_per_hour: 'キロメートル毎時',
    _and: 'および',
    _seconds_per_kilometers: '秒毎キロメートル',
    _confirm_delete: 'このセッションを削除してもよろしいですか?',
    _confirm_delete_eq: 'この機器を削除してもよろしいですか?',
    _delete_eq: '削除',
    _gpx_export_title: 'GPX エクスポート',
    _gpx_file_exported: 'すべてのセッションを GPX ファイルとしてエクスポートしました。',
    _backup_ok_title: 'バックアップ',
    _backup_ok_content: 'バックアップは、アプリケーションのデータフォルダー内で利用可能です。',
    _backup_error_title: 'エラー',
    _backup_error_content: 'バックアップの作成中にエラーが発生しました。',
    _gpx_error_title:'エラー',
    _gpx_error_content:'GPX エクスポートに失敗しました。',
    _gpx_import_title: 'GPX インポート',
    _gpx_file_imported: 'すべてのファイルをインポートしました。',
    _toggle_music_on_announce: 'アナウンス時に音楽を切り替え',
    _announce_distance: '距離をアナウンス',
    _announce_time: '時間をアナウンス',
    _announce_average_speed: '平均スピードをアナウンス',
    _announce_average_pace: '平均ペースをアナウンス',
    _announce_heartrate: '心拍数をアナウンス',
    _delay_start: '10 秒間開始を遅延',
    _export_as_gpx: 'GPX としてエクスポート',
    _import_gpxs: 'GPX ファイルをインポート',
    _debug_tools: 'デバッグツール',
    _debug_mode: 'デバッグモード',
    _settings: '設定',
    _debug_test_vocal: '音声アナウンスのテスト',
    _average:'平均',
    _records:'記録',
    _speed_kph: 'スピード (Kph)',
    _duration_minutes: '持続時間 (分)',
    _altitude_meters: '高度 (メートル)',
    _time:'時間',
    _distance:'距離',
    _speed:'スピード',
    _pace: 'ペース',
    _debug_warning: 'デバッグモードは、アプリケーションが非常に遅くなります',
    _run_fast: 'もっと速く走りましょう !',
    _run_slow: 'もっとゆっくり走りましょう !',
    enUS: '英語',
    frFR: 'フランス語',
    deDE: 'ドイツ語',
    jaJP: '日本語',
    _privacy_policy_text: 'ForRunners は、Openstreet.net サービスから地図を取得するとき、およびデバッグモードを有効にしないかぎり、お使いのデバイス外と何の情報も通信しません。 この最後の場合、デバッグのため、エラーおよびデバッグメッセージが私のサーバーに送信されます。',
    _short_description: 'ランナー専用の GPS 追跡アプリケーション。',
    _use_open_source_text : 'ForRunners は、次のオープンソース プロジェクトの部品またはライブラリーを使用しています',
    _by : 'By',
    _swipe_left: '左にスワイプすると停止します',
    _stop: '停止',
    _elevationUp: '上',
    _elevationDown: '下',
    _sessions: 'セッション',
    ...
    _best_records: 'ベスト',
    _average_records: '平均',
    _fraction: 'インターバル トレーニング',
    _duration_slow_interval: 'ゆっくりなインターバル',
    _duration_fast_interval: '早いインターバル',
    _welcome_text: 'ForRunners の初回のご利用のようです。 下のプラスボタンでランニングの記録を開始するか、設定で GPX ファイルから以前のランニングのセッションをインポートすることができます。',
    _announce_fraction: 'インターバルのアナウンス',
    _empty_records_text: '残念ながら、まだランニングのセッションを記録していません。',
    _open_source_content: 'オープンソースコンテンツ',
    _bpm: '心拍数',
    _bpms_label: 'bpms',
    _vocal_bpms_label: '拍毎分',
    _donation: 'このアプリを発展させたい、あるいは喜んでいただけた場合は、bitcoin で寄付することができます:',
    _keep_screen_on: 'ランニング中画面を維持する',
    _hr_zone0:'リカバリー',
    _hr_zone1:'脂肪代謝',
    _hr_zone2:'有酸素パワー',
    _hr_zone3:'スピード持久力',
    _hr_zone4:'最大スプリント',
    _heartRate:'心拍数',
    _heartrate_max:'最大心拍数の周期',
    _heartrate_min:'安静時心拍数の周期',
    _heartrate_label:'Bpm',
    _bluetooth_devices:'Bluetooth デバイス',
    _scan_ble:'デバイスの検索',
    _help: 'ヘルプ',
    _report_issue: 'GitHub で問題を報告',
    _gps_accuracy: 'GPS 精度 :',
    _delete: '削除',
    _overnote: 'スコア',
    _total: '合計 :',
    _score: 'スコア :',
    _restore_ok_content: 'バックアップを復元しました',
    _restore_ok_title: '復元',
    _use_google_elevation_api: 'Google 標高 API を使用する',
    _speed_vs_altitude: 'スピード VS 標高',
    _speed_vs_heartrate: 'スピード VS 心拍数',
    _altitude_vs_heartrate: '標高 VS 心拍数',
    _help_subtitle_1: 'ForRunners にようこそ! この簡単なヘルプでは ForRunners の主なコンセプトを説明します。 このヘルプ内を移動するには、下の次へと前へのボタンを使用します。',
    _help_desc_1: 'メイン画面は、すべてのランニングのセッションを表示します。 <br><br><b>1-</b> このボタンは、新しいランニングのセッションを開始します<br><br><b>2-</b> すべてのセッションから算出した平均の統計<br><br><b>3-</b> あなたのベストのランニング記録<br><br><b>4-</b> セッションのラウンド長<br><br><b>5-</b> ランニングの難易度を示すスコア<br><br><b>6-</b> スコアの進展と持続時間の進展を示すグラフ',
    _help_subtitle_2: 'これはセッションの詳細です。地図にランと一緒に詳細な統計とグラフを表示します。',
    _help_desc_2: '<b>1-</b> OpenStreetMap 地図。ランを表示します<br><br><b>2-</b> 青いマーカーはキロメートルのマーカーです。緑の "S" マーカーは "開始" で、赤の "E" マーカーは "終了" です<br><br><b>3-</b> このアイコンはランの共有用です<br><br><b>4-</b> このアイコンはセッションの削除用です<br><br><b>5-</b> ランニング セッションの日付と、再開の値。',
    _help_desc_3: '<b>1-</b> 日付<br><br><b>2-</b> 平均スピード<br><br><b>3-</b> 平均ペース<br><br><b>4-</b> 距離<br><br><b>5-</b> 持続時間 hh:mm<br><br><b>6-</b> メートル単位の合計標高<br><br><b>7-</b> メートル単位の合計下り<br><br><b>8-</b> ランニング日の天気<br><br><b>9-</b> スコア, 持続時間, 距離, ペース<br><br>',
    _help_subtitle_3: ' ',
    _help_subtitle_4: ' ',
    _help_desc_4: 'X 軸 (2) はキロメートルを保持し Y 軸 (3) はスピードを示します。色 (1) は心拍数ゾーンを示します (Bluetooth 心拍数モニターと互換性のあるスマーフォンが必要です)',
    _help_subtitle_5: ' ',
    _help_desc_5: 'X 軸 (2) はキロメートルを保持し Y 軸 (3) は高度を示します。色 (1) は心拍数ゾーンを示します (Bluetooth 4.0 心拍数モニターと互換性のあるスマーフォンが必要です)',
    _help_subtitle_6: ' ',
    _help_desc_6: '<b>1-</b> セッションの間の平均心拍数<br><br><b>2-</b> グラフは各心拍数ゾーンの持続時間を示します<br><br><b>3- </b> キロメートルによるペース、スピード、心拍数を含む表。<br><br>さあ、次へをクリックして最初のランニングのセッションを始めるか、設定から過去のセッションをインポートしてください。',
    _previous:'前へ',
    _next:'次へ',
    _gps_lost:'GPS 信号を失いました',
    _gps_got:'GPS 信号を回復しました',
    _announce_gpslost: 'GPS 信号を失ったときにアナウンス',
    _recording_session: 'セッションの記録中 ...',
    _speed_in_mvt: '移動スピード',
    _pace_in_mvt: '移動ペース',
    _spm_label: 'spm',
    _power: 'パワー',
    _cadence: '歩調',
    _sendlogs: 'ログを送信',
    _equipments: '機器',
    _add_equipment: '機器を追加',
    _duration_interval_detail: '一定のインターバルで情報をアナウンス',
    _distance_interval_detail: 'キロメートルのインターバルで情報をアナウンス',
    _heartrate_min_detail: '目を覚ました後に測定した安静時の心拍数',
    _heartrate_max_detail: '20 分のウォームアップ直後、4 分のスプリントでの最大心拍数。'
  });
