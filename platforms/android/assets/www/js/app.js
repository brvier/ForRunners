...
$translateProvider.translations('de-DE', {
    ...
    _duration_interval: 'Ansagehäufigkeit',
    _minutes: 'Minuten',
    _hours: 'Stunden',
    _options: 'Optionen',
    _backup_and_restore: 'Sichern und wiederherstellen',
    _restore: 'Wiederherstellen',
    _backup: 'Sichern',
    _distance_interval: 'Streckenintervall',
    _notification_slug: 'ForRunners : Aufzeichnung der Trainingseinheit ...',
    _notification_message: 'Aufzeichnung der Trainingseinheit ...',
    _go: 'Start!',
    _kilometers: 'Kilometer',
    _kilometers_per_hour: 'Kilometer pro Stunde',
    _and: 'und',
    _seconds_per_kilometers: 'Sekunden pro Kilometer',
    _confirm_delete: 'Aufzeichnung wirklich löschen?',
    _confirm_delete_eq: 'Zubehör wirklich löschen?',
    _delete_eq: 'Löschen',
    _gpx_export_title: 'GPX-Export',
    _gpx_file_exported: 'Alle Aufzeichnungen als GPX-Datei exportieren.',
    ...
    _pace: 'Tempo',
    _debug_warning: 'Der Debug-Modus verlangsamt die Anwendung',
    _run_fast: 'Schneller laufen!',
    _run_slow: 'Langsamer laufen!',
    enUS: 'Englisch',
    frFR: 'Französisch',
    deDE: 'Deutsch',
    _privacy_policy_text: 'ForRunners versendet keine Daten vom Gerät außer für den Service von Openstreet.net oder im Debug-Modus. Im Debug-Modus werden die Fehler- und Debug-Nachrichten an meinen eigenen Server gesendet.',
    ...
    _distk: 'Typ',
    _duration: 'Zeit',
    _best_records: 'Bestleistungen',
    _average_records: 'Durchschnitt',
    _fraction: 'Intervalltraining',
    _duration_slow_interval: 'Langsames Intervall',
    _duration_fast_interval: 'Schnelles Intervall',
    _welcome_text: 'Es sieht so aus als ob du ForRunners zum ersten mal startest. Du kannst eine Aufzeichnung mit dem Plus-Zeichen unten starten oder eine GPX-Datei mit älteren Aufzeichnungen importieren.',
    _announce_fraction: 'Intervall-Ansage',
    _empty_records_text: 'Es sind keine Aufzeichnungen vorhanden.',
    ...
    _total: 'Total:',
    _score: 'Ergebnis:',
    _restore_ok_content: 'Sicherung wiederhergestellt',
    ...
    _help_subtitle_1: 'Willkommen bei ForRunners! Diese kleine Übersicht beschreibt die Funktionen von ForRunners. Benutze die Vor- und Zurück-Schaltflächen, um in der Hilfe zu blättern.',
    _help_desc_1: 'Der Hauptbildschirm zeigt alle aufgezeichneten Läufe. <br><br><b>1-</b> Dieser Knopf startet einen neuen Lauf<br><br><b>2-</b> Durchschnitt aller Läufe<br><br><b>3-</b> Deine Laufrekorde<br><br><b>4-</b> Gerundete Länge des Laufs<br><br><b>5-</b> Eine Punktzahl über den Schwierigkeitsgrad des Laufs<br><br><b>6-</b> Ein Diagramm, das die Entwicklung der Ergebnisse und der Dauer anzeigt',
    ...
    _spm_label: 'spm',
    _power: 'Kraft',
    _cadence: 'Schrittfrequenz',
    _sendlogs: 'Sende Logdateien',
    _equipments: 'Geräte',
    _add_equipment: 'Füge Gerät hinzu',
