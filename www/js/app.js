...
.config(function($stateProvider, $urlRouterProvider, $translateProvider, $ionicConfigProvider, $logProvider, $compileProvider) {
  ...
  $translateProvider.translations('en-US', {
    ...
    _cadence: 'Step Rate',
    _sendlogs: 'Send logs',
    _equipments: 'External Devices',
    _add_equipment: 'Add a device',
...
$translateProvider.translations('de-DE', {
    ...
    _empty_records_text: 'Zurzeit keine existierende Aufnahmen, es gibt keinen Rekord zu schlagen',
    _open_source_content: 'Open Source Inhalte',
    _bpm: 'Herzfrequenz',
    _bpms_label: 'bpms',
    _vocal_bpms_label: 'Schläge pro Minute',
    _donation: 'Wenn du willst, dass die App weiter entwickelt wird oder du dich Bedanken willst, sende Bitcoins an:',
    ...
    _help_subtitle_2: 'Das ist die Detailansicht einer Aufzeichnung, sie zeigt den Lauf auf einer Karte inklusive Statistiken und Grafiken an.',
    _help_desc_2: '<b>1-</b> Die OpenStreetMap Karte zeigt deinen Lauf<br><br><b>2-</b> Die blauen Markierungen zeigen die Kilometer an, die grüne Markierung ist der Startpunkt und die rote Markierung ist der Zielpunkt<br><br><b>3-</b> Mit diesem Icon teilst du deinen Lauf<br><br><b>4-</b> Dieses Icon löscht den aktuellen Lauf<br><br><b>5-</b> Datum und Uhrzeit des Laufs.',
    ...
    _help_subtitle_3: ' ',
    _help_subtitle_4: ' ',
    _help_desc_4: 'Die X-Achse (2) zeigt die Kilometer, die Y-Achse (3) zeigt die Geschwindigkeit und die Farben (1) zeigen die Herzfrequenz-Zonen (benötigt einen kompatiblen Bluetooth-Herzfrequenz-Messer)',
    _help_subtitle_5: ' ',
    _help_desc_5: 'Die X-Achse (2) zeigt die Kilometer, die Y-Achse (3) zeigt die Höhenmeter, und die Farben (1) zeigen die Herzfrequenz-Zonen (benötigt einen kompatiblen Bluetooth-Herzfrequenz-Messer)',
    _help_subtitle_6: ' ',
    _help_desc_6: '<b>1-</b> Durchschnittliche Herzfrequenz des Laufs <br><br><b>2-</b> Tabelle mit Distanz, Ergebnis, Geschwindigkeit und Herzfrequenz.<br><br><b>3- </b> Die Grafik zeigt die Dauer der Herzfrequenz-Zonen des Laufs.<br><br>Und jetzt drücke Start für deinen ersten Lauf oder Importiere ältere Läufe in den -Einstellungen-',
    _previous: 'Zurück',
    _next: 'Vor',
  ...
  $translateProvider.translations('de-AT', {
    ...
    _backup_ok_content: 'Cópia de segurança disponivel na pasta de dados da applicação.',
    _backup_error_title: 'Erro',
    _backup_error_content: 'Um erro ocorreu aquando da criação da Cópia de segurança.',
    ...
    deAT: 'Alemão (Austria)',
    ptPT: 'Português',
    _privacy_policy_text: 'ForRunners não comunica nenhuma informação para fora do seu dispositivo, exceto para obter mapas de serviços em  "Openstreet.net" e se você ativar o modo de depuração. Neste último caso, qualquer erro e mensagem de depuração serão enviados para o meu servidor para despiste. ',
    _short_description: 'Aplicação de tracking GPS dedicada a corredores.',
    _use_open_source_text : 'ForRunners usa partes ou livrarias dos seguintes projetos fonte-aberta',
    _by : 'Por',
    ...
    _welcome_text: 'Parece que é a primeira vez que você usa ForRunners. Pode começar a gravar sua execução com o botão abaixo ou importando uma sessão de execução mais antiga a partir de arquivos GPX nas configurações.',
    _announce_fraction: 'Aviso de intervalo',
    _empty_records_text: 'Não tem nenhuma sessão de corrida gravada, ainda não tem nenhum registo para derrotar.',
    _open_source_content: 'Conteudo Fonte-Aberta',
    _bpm: 'Batimento cardiaco',
    _bpms_label: 'bpms',
    _vocal_bpms_label: 'Batimentos por minutos',
    _donation: 'Se quer ver esta aplicação evoluir ou apenas agradecer-me, pode fazer uma doação em bitcoin:',
    ...
    _help_subtitle_1: 'Bem-vindo ao ForeRunners! Essa pequena ajuda tentará explicar o conceito principal de ForeRunners. Use o botão seguinte e anterior abaixo para navegar nesta ajuda.',
    _help_desc_1: 'Este é o ecrã principal apresenta todas as suas sessões de corrida. <br> <br> <b> 1 - </ b> Este botão inicia uma nova sessão de corrida. <br> <br> <b> 2 - </ b> As estatísticas médias são calculadas a partir de todas as sessões <br> <br> <b> 3 - </ b> Os seus melhores registos de corrida <br> <br> <b> 4 - </ b> Aarredondamento do comprimento da sessão <br> <br> <b> 5 - </ b> A pontuação representa a dificuldade da sua corrida <br> <br> <b> 6 - </ b> Um gráfico que mostra a evolução da pontuação e a evolução da duração',
    _help_subtitle_2: 'Este é o detalhe de uma sessão, mostra todas as corridas no mapa, com graficos e estatisticas detalhadas.',
    _help_desc_2: '<b> 1 - </ b> O mapa OpenStreetMap, mostra a sua corrida <br> <br> <b> 2 - </ b> O marcador azul é um marcador de Kilometragem, enquanto o marcador verde "S" é para "Iniciar" e marcador vermelho "E" para "Terminar" <br> <br> <b> 3 - </ b> Este ícone é para compartilhar a sua corrida <br> <br> <b> 4 - </ b> Este ícone é para excluir a sua sessão <br> <br> <b> 5 - </ b> Data da sua sessão de corrida com o resumo de valores.',
    _help_desc_3: '<b> 1 - </ b> Data <br> <br> <b> 2 - </ b> Velocidade média <br> <br> <b> 3 - </ b> Ritmo médio <br> <br> <b> 4 - </ b> Distância <br> <br> <b> 5 - </ b> Duração hh: mm <br> <br> <b> 6 - </ b> Elevação total em metros <br > <br> <b> 7 - </ b> Elevação minima em metros <br> <br> <b> 8 - </ b> Tempo na data da corrida <br> <br> <b> 9- </ b> Pontuação, duração, distância, ritmo <br> <br>',
    _help_subtitle_3: ' ',
    _help_subtitle_4: ' ',
    _help_desc_4: 'O eixo X (2) mostra os Kilômetros e o eixo y (3) mostra a velocidade, enquanto as cores (1) mostram a zona do batimento cardiaco (Exige um sensor corporal bluetooth e um smartphone compatível)',
    _help_subtitle_5: ' ',
    _help_desc_5: 'O eixo X (2) mostra os Kilômetros e o eixo y (3) mostra altitude, enquanto as cores (1) mostram a zona do batimento cardiaco (Exige um sensor corporal bluetooth e um smartphone compatível)',
    _help_subtitle_6: ' ',
    _help_desc_6: '<b> 1 - </ b> Freqüência cardíaca média durante a sessão <br> <br> <b> 2 - </ b> Gráfico que mostra a duração em cada zona de frequencia cardiaca <br> <br> <b> 3- < / b> Tabela com ritmo, velocidade e frequencia cardiaca por Kilometros. <br> <br> Agora clique em seguida e comece sua primeira sessão em execução ou importe as sessões anteriores das preferências.',
    _previous:'Anterior',
    _next:'Seguinte',
